...
directory. Open this file to verify that the following has been added:
...
```{r eval=FALSE}
myPkgName:::idxstats_pbam(ompBAM::example_BAM("Unsorted"), 2)
```
...
```{r eval=FALSE}
# Add the following code to an `.R` file and place it in the `R/` subdirectory
